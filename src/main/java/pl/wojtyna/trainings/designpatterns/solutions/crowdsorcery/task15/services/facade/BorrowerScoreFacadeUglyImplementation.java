...
public class BorrowerScoreFacadeUglyImplementation implements BorrowerScoreFacade {

    private final ConnectionManager connectionManager;
    private final JdbcDatabase jdbcDatabase;
    private final MongoDatabase mongoDatabase;

    public BorrowerScoreFacadeUglyImplementation(ConnectionManager connectionManager,
